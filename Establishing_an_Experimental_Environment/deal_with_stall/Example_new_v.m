% 定义文件夹路径
folder_path = 'E:\jwh_gan\MATLAB\verification\CL_CD\cl_cd_ok_v';
...
% 打印出最大功率系数、对应的翼型及TSR
fprintf('The best aero profile is %s with a maximum Cp of %f at TSR = %f\n', best_profile, max_cp, best_tsr);
